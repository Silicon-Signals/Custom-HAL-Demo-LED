...
PRODUCT_COPY_FILES += \
    ...
    $(IMX_DEVICE_PATH)/staged-installer-whitelist.xml:product/etc/sysconfig/staged-installer-whitelist.xml
...
PRODUCT_COPY_FILES += \
    ...
    $(CONFIG_REPO_PATH)/common/audio-json/nau8822_config.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/audio/nau8822_config.json \
